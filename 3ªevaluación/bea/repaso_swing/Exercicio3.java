...
public class Exercicio3 extends JFrame {
    ...
    JMenuItem submenuVerde = new JMenuItem("Verde");
    JMenuItem submenuAzul = new JMenuItem("Azul");
    ...
    public Exercicio3() {
        ...
        barraMenu.add(menu1);
        barraMenu.add(menu2);
        barraMenu.add(menuCor);

        menuCor.add(submenuAzul);
        menuCor.add(submenuVerde);
        ...
        panel.add(etiqueta);
        etiqueta.setOpaque(true); // Para que a cor de fondo sexa visible
    ...
    public static void main(String[] args) {
        Exercicio3 panel = new Exercicio3();
    ...
    private class CambiarColor implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == submenuAzul) {
                etiqueta.setBackground(Color.BLUE);
            } else if (e.getSource() == submenuVerde) {
    ...
    private class CambiarColorConBoton implements ActionListener {
